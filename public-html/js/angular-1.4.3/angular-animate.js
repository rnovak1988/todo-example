 ...
 * `stagger` time value of `0.1` is used then there will be a stagger delay of `600ms`)
  ...
  this.$get = ['$window', '$$jqLite', '$$AnimateRunner', '$timeout',
    ...
    function init(element, options) {
      ...
      function close(rejected) { // jshint ignore:line
        ...
        // the reason why we have this time is to allow a synchronous closing callback
